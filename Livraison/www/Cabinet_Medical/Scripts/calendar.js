 ...
 */
function insertCalendar(positionLeft,positionTop) 
{
...
function addMainDiv(calendarDiv) {
    ...
    cell.appendChild(getImg("../Images/interface/arrow_left.gif"));
    
    cell = row.insertCell(1);
    cell.id = "cal_m_01";
    cell.onclick = incrementMonth;
    cell.appendChild(getImg("../Images/interface/arrow_right.gif"));
    ...
    cell.id = "cal_m_03";
    cell.onclick = updateMonthChoiceVisibility;
    cell.appendChild(getImg("../Images/interface/arrow_down.gif"));    
    ...
    var img = getImg("../Images/interface/l_cancel.gif");
    img.width = "15";
    img.height = "13";
...
function addYearDiv(calendarDiv) {
    ...
    var cell = row.insertCell(0);
    var img = getImg("../Images/interface/arrow_left.gif");
    ...
    cell = row.insertCell(2);
    img = getImg("../Images/interface/arrow_right.gif");
...
function initElement(id, evt) {
    ...
    if (rightedge < calendar.cal.offsetWidth) {
        elementStyle.left =  clientX - hGap - calendar.cal.offsetWidth;
    } else {
...
function displayCalendar(id,positionLeft,positionTop, ev) {
    if (insertCalendar(positionLeft,positionTop)) {
