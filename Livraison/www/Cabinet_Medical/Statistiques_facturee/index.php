...
<div id="contenu">
    ...
    <div id="bloc">
        <h2>Consultation des statistiques commandes factur&eacute;es</h2>
        ...
        <table>
            <tr>
                <th>Nombre de commandes factur&eacute;es</th>
            ...
            $query = "SELECT count(*) AS NB FROM COMMANDE WHERE  STR_TO_DATE(COMMANDE_FACTURATION , '%d-%m-%Y' )>='".$dateDebut."' AND STR_TO_DATE(COMMANDE_FACTURATION , '%d-%m-%Y')<='".$dateFin."'" ;
            ...
            else
            {
             ...
             $query = "SELECT sum(COMMANDE_PRIX) AS CA FROM COMMANDE WHERE STR_TO_DATE(COMMANDE_FACTURATION , '%d-%m-%Y' )>='".$dateDebut."' AND STR_TO_DATE(COMMANDE_FACTURATION , '%d-%m-%Y')<='".$dateFin."'" ;
        ...
        <h2>la liste des commandes factur&eacute;es </h2>
        ...
        <?php
            echo '<table>
                ...
                $query = "SELECT * FROM COMMANDE INNER JOIN CLIENT ON COMMANDE_CLIENT_NUM = CLIENT_NUM WHERE STR_TO_DATE(COMMANDE_FACTURATION , '%d-%m-%Y' )>='".$dateDebut."' AND STR_TO_DATE(COMMANDE_FACTURATION , '%d-%m-%Y')<='".$dateFin."'" ;
                $result = mysql_query("$query");
                while ($row = mysql_fetch_array($result)) 
              {
